        ...
        <div className="footer-content">
          <div className="footer-newsletter">
            <span className="footer-content1 thq-body-small">
              <span className="footer-text1">Octet</span>
              <span> Systems</span>
            </span>
          ...
          <div className="footer-links">
            ...
            <div className="footer-column2">
              <strong className="footer-column2-title thq-body-large">
                {props.column2Title}
              </strong>
              <div className="footer-footer-links2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer-link6 thq-body-small"
                >
                  {props.link6}
                </a>
                <a
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer-link9 thq-body-small"
                >
                  {props.link9}
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer-link10 thq-body-small"
                >
                  {props.link10}
                </a>
              </div>
            ...
            <div className="footer-column3">
              <strong className="footer-social-link1-title thq-body-large">
              ...
              <div className="footer-social-links">
                <div className="footer-link14">
                  ...
                  <span className="footer-social-link1 thq-body-small">
                    Facebook
                  </span>
                </div>
                <div className="footer-link15">
                  ...
                  <span className="footer-social-link2 thq-body-small">
                    Instagram
                  </span>
                </div>
                ...
                <div className="footer-link17">
                  ...
                  <span className="footer-social-link4 thq-body-small">
                    LinkedIn
                  </span>
                </div>
...
Footer.defaultProps = {
  ...
  link6: 'Mobile App Development',
  cookiesLink: '/cookie-policy',
  action1: 'Subscribe ',
  column1Title: 'Services',
  link8: 'Contact Us',
  link2: 'Cyber Security',
  link4: 'Electronic Security Systems',
  content3: 'Octet Systems',
  link5: 'Web Development',
  privacyLink: '/privacy-policy',
  link7: 'About Us',
  link9: 'Careers',
  link3: 'System Support',
  content2: 'Stay up to date with our latest news and updates.',
  column2Title: 'Company',
  termsLink: '/terms-and-conditions',
  link1: 'Network Solutions',
  link10: 'Blog',
}
