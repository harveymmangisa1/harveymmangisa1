...
Steps.defaultProps = {
  step1Description:
    'We start by understanding your specific needs and requirements to provide tailored solutions.',
  step4Description:
    'Our support team is available round the clock to address any issues, provide maintenance, and ensure optimal performance.',
  step3Title: 'Implementation',
  step2Title: 'Planning',
  step4Title: 'Support',
  step1Title: 'Consultation',
  step2Description:
    'Our team of experts will create a detailed plan outlining the strategies and technologies to be implemented.',
  step3Description:
    'We execute the plan with precision, ensuring seamless integration and minimal disruption to your operations.',
}
